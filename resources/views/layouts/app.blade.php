        ...
        <div class="sidebar-user">
            <div style="display:flex; align-items:center; gap:10px;">
                ...
                <div>
                    ...
                    <div class="user-role">
                        @if(auth()->user()->role === 'doyen') Doyen
                        @elseif(auth()->user()->role === 'chef_filiere') Chef de Filière
                        @elseif(auth()->user()->role === 'etudiant') Étudiant
            ...
            @auth
                ...
                @if(auth()->user()->role === 'doyen')
                    ...
                    <a href="{{ route('doyen.utilisateurs') }}"
                       class="{{ request()->routeIs('doyen.utilisateurs*') ? 'active' : '' }}">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('doyen.conventions') }}"
                       class="{{ request()->routeIs('doyen.conventions*') ? 'active' : '' }}">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
